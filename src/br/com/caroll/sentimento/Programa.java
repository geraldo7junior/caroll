...
public class Programa extends Thread {
	...
	public void alimentaBase() {
		...
		try {
			...
			todosResultados.addAll(exe.getTweets("eros�o"));
			...
			todosResultados.addAll(exe.getTweets("extin��o"));
			todosResultados.addAll(exe.getTweets("meio-ambiente"));
			todosResultados.addAll(exe.getTweets("preserva��o"));
	...
	public void imprimeTweetsScore(List<Status> tweets) throws FileNotFoundException {
		LimpadorTexto limp = new LimpadorTexto();
		Classificador classificador = new Classificador();
