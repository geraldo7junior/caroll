...
private Scanner sp;
  ...
  public String[] getSentencaAnalisadaScore (String sentenca) throws FileNotFoundException {
    String[] st = new String[2];
  ...
  public List<String[]> classificaTweetsScore (List<String> tweets) throws FileNotFoundException {
